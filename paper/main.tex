...
\title{Letting computers call the shots --- exploring the impact of AI in high-stakes decision-making} %% Article title
...
% Why are we havinig this conversation now?

% What do we already know and what do we need to know?

% What are the limitations of past research?
% Some nearest neighbor papers to compare gaps with in the introduction:
% Unpacking Human-AI Interaction in Safety-Critical Industries: A Systematic Literature Review: https://ieeexplore.ieee.org/abstract/document/10620168
% Makes broad calls for explainability across applications without considering nuances of use case
% Only talks about regulation in calls for standardizing terminology— doesn't make any recommendations or considers the impacts of current regulation
% Focuses on human interaction, doesn't do industry-specific analysis, and doesn't make development recommendations
% Doesn't consider what “trust” is, instead points to “user personality”
% Doesn't discuss validation methods


% Artificial intelligence in safety-critical systems: a systematic review: https://www.emerald.com/imds/article/122/2/442/183810
% Doesn't consider level of decision-making autonomy
% Does encourage validation and explanations, but doesn't differentiate between when each is needed/useful. Actually implies that they might be one in the same…
% Doesn't consider specific industries
% Overly broad scope: 30 years of data + no publication criteria (search was done on google scholar and included pre-prints)
% Heavily focused on use of the term “safety-critical” without unpacking what that might constitute in search terms, so “safety-critical” applications were surely missed just because they didn't use that exact wording. 
% No discussion of laws/regulations

% To address these gaps, we complete this review...

\subsection{Novelty}


While the safety outcomes we consider all include some threat to human health or safety, the diversity of these industries means that use of AI may risk the health of one to many individuals with low to high probability. This variety supports our conclusions as generalizable. Aside from the size of the affected population and the likelihood of an incident, the applications include variety in \textit{who} interacts directly with the AI system in question and the time they have to decide (or intervene). Our study brings novelty to the field by distilling key qualities of sensitive industries, understanding how AI affects outcomes based on those qualities, and identifying how those interactions impact safety, trust, and liability. Further, we make recommendations for regulators, users, and developers based on these findings.  
...
\end{enumerate} 
These questions distinguish the unique features and outcomes that set AI-based decision-making mechanisms apart from traditional methods. Likewise, answers would allow useful insight for both governmental agencies and engineers to mitigate evident shortcomings of this high-impact technology. 
...
\begin{figure}
    \centering
    % \resizebox{0.5\columnwidth}{!}{\input{figs/dag.tex}}
...
Briefly, the FDA offers three main pathways for licensing depending on the level of rigor of their review. This includes Pre-market approval (PMA), \textit{De Novo}, and 510(k), in increasing order of level of rigor. \textit{De Novo}, the newest, offers a hybrid pathway that offers neither all the litigation protections of the most stringent nor all the speed of the fastest. Though outcomes of this pathway remain legally uncertain, AI/ML-enabled device manufacturers use the \textit{De Novo} pathway about three times more often \cite{gerkeNewCaseLaw2025}, suggesting these companies prefer to opt for uncertainty in future liability defense in exchange for expedited approval. This may concern the public as they rely on the FDA's trustworthiness assessment for these (and non-AI) devices. A more thorough approach may include rigorous validation techniques and/or a unique licensing pathway for a unique set of technologies, especially for treatment devices that necessarily elicit trust.
...
% Over Trusting
Having established how regulation relates trust and trustworthiness, we can now consider how developers and users each evaluate these AI systems-- and the consequences of their misalignment. We can accomplish this first by understanding O'Neil's three constituents of trust, as described by Jones et al.\cite{jonesArtificialIntelligenceClinical2023}: trust in truth claims, trust in commitment, and trust in competence. The first is an empirical evaluation, \textit{is this entity likely to give me a factually correct answer?}, whereas the second two are normative, \textit{is this entity likely to follow through on their promises?}, and \textit{is this entity likely to execute the promised action successfully?}. Developers typically focus on the empirical arm of these, as evidenced by the quantitative way we evaluate AI systems: \textit{given 1,000 scenarios, how often will my system predict the correct answer?} Yet, we seldom consider the other two thirds of how people perceive trust when we set out to develop a ``trustworthy system.'' This misalignment can set users up to overtrust a system that has obvious limitations to the developer. 
...
\subsection{Nuclear}
Nuclear systems comprised nearly 10\% of our final subset of articles. This subset varied possibly the most in terms of nuclear application, with most studies we considered toeing the line with predictive maintenance, a classification we excluded from this analysis. All papers related to the operation of nuclear power plants in this section, which was six of the seven papers, used traditional machine learning methods (i.e., decision trees, random forests, feedforward neural networks) plus more complex models, like Bayesian belief networks and long-short term memory networks. The only paper unrelated to nuclear power plants was focused on nuclear crisis management and used generative AI in its analysis \cite{holmesRoleArtificialIntelligence2024}. Holmes et al. \cite{holmesRoleArtificialIntelligence2024} generally stood out as an outlier in this category, not only because the application area broadly differed, but because it focused on using generative AI to avoid the pitfalls of human emotion in high-stakes political decision-making scenarios. In most of the studies we consider in this work, AI is used to support decision-making from a logical, data-based perspective, but in this case, the AI is used to assist in a somewhat emotional capacity. While this paper met all of our inclusion criteria, it serves a small audience and is basically unregulated. Still, it emphasizes a need for humans to remain in the loop for expert-level decision-making. 
...
The authors would like to thank Riley Fisher for his feedback and suggestions during review, Leo Tunkle for his help with early abstract screenings, and Sam Dotson for his feedback during methodology development. 
...
\textcolor{blue}{@Majdi, please check this! I copied from KAN.}
\begin{itemize}
