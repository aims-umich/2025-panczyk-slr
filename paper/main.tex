...
This all makes sense in theory, but do we have the evidence to back it up? In fact, we do. 

\textcolor{red}{THIS PART ISN'T DONE YET!}
% describe how jones summarizes studies that show patients accept AI more than clinicians because they trust its "process" but clinicians have doubts about the empirical accuracy
% find other evidence too!
% automation bias fits into this-- the default to trust the computer because you percieve it as more reliable has nothing to do with the empirical accuracy
