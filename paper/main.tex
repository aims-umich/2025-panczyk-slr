...
\subsection{Medical}
Medical papers comprised nearly 60\% of our final subset of articles (see Table \ref{tab:industry_distribution}). As the largest industry in article numbers from both the query results and the final subset analysis, the medical industry has a lot to offer in terms of experience using AI systems and highly sensitive usage demands. 
