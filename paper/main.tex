...
Following the PRISMA methodology, we perform the screening process in two phases--1) title and abstract screening, and 2) full-text review. 

\begin{table}[htbp]
\centering
\caption{Inclusion and exclusion criteria formatted with multirow alignment.}
\label{tab:multirow_criteria}
\renewcommand{\arraystretch}{1.3} % Adds breathing room between rows
\begin{tabularx}{\textwidth}{lXX}
\toprule
\textbf{Category} & \textbf{Inclusion Criteria} & \textbf{Exclusion Criteria} \\ \midrule

\multirow{4}{*}{\textbf{Study}} &  Peer-reviewed journal articles &  Non-systematic literature reviews  \\
&  Select conference papers (NEURIPS, ICLR, ICML, AAAI, IJCAI) &  Retracted articles \\ & & Ethics-focused analyses \\
 \midrule

\multirow{4}{*}{\textbf{Population}} &  Sensitive tech (nuclear, transport, aerospace, energy) &  Finance \\
&  Medical studies (equipment, devices, or drugs) &  Healthcare systems (not tech-specific) \\
& &  HR applications \\
& &  Cybersecurity \\ \midrule

\multirow{3}{*}{\textbf{Intervention}} &  AI/ML-informed decision-making &  If/else logic only \\
&  Human-in or out-of-the-loop &  Non-computer algorithmic DM \\
& &  Linear regression models \\ \midrule

\multirow{2}{*}{\textbf{Comparator}} &  Deterministic codes/methods & \multirow{2}{*}{ ML-ML comparisons} \\
&  Anything that is not ML & \\ \midrule

\multirow{3}{*}{\textbf{Outcome}} &  Incidents, accidents, and failures &  Non-threat to human health risks \\
&  Threat to human health/safety &  Financial risks \\
&  Regulatory compliance violations &  Cyber risks (non-human health) \\ \midrule

\multirow{2}{*}{\textbf{Other}} & \multirow{2}{*}{N/A} &  Published before 2015 \\
& &  Not written in English \\ \bottomrule
